# Scheme Circular: Cementitious Booster - Putty FY26
...
## 3. Incentive structure (instant mode, fixed slab, discount)
- {"min_value": 0, "payout_pct": 4.0}
...
## 6. Budget & caps
Total scheme budget: Rs 1,800,000. The company may cap total per-invoice discount where multiple schemes apply.
